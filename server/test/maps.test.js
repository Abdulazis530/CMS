...
describe('>>>TESTING MAPS API<<<', () => {
    ...
    it('Should search data from user input when accessing /api/maps/search', async () => {
        ...
        searchData1.body.data[0].should.have.property('title');
        searchData1.body.data[0].should.have.property('lat');
        searchData1.body.data[0].should.have.property('lng');
        searchData1.body.data[0].title.should.equal('Cihampelas Walk');
        searchData1.body.data[0].lat.should.equal(-6.8965457);
        searchData1.body.data[0].lng.should.equal(107.6103536);
    ...
    it('Should list ALL data from database /api/maps/ GET', async () => {
        ...
        data.body.should.have.property('totalData');
        data.body.should.have.property('data');
        data.body.data[0].should.have.property('_id');
        data.body.data[0].should.have.property('title');
        data.body.data[0].should.have.property('lat');
        data.body.data[0].should.have.property('lng');
        data.body.data[0].title.should.equal('Trans Studio Mall');
        data.body.data[0].lat.should.equal(-6.9261257);
        data.body.data[0].lng.should.equal(107.6343728);
